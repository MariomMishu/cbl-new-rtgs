...
@Repository
public class CreatedUserInfoSpecification {
    ...
    public static Specification<UserInfoEntity> all(UserInfoFilter filter) {
        ...
        specification = specification.and(SpecificationBuilder.equal(UserInfoEntity_.IS_DELETED, false))
                .and(SpecificationBuilder.equal(UserInfoEntity_.ACTIVATED, false))
                .and(SpecificationBuilder.notEqual(UserInfoEntity_.CREATED_BY, filter.getCreatedBy()));
