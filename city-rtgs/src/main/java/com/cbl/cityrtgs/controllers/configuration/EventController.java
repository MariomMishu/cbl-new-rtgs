...
import com.cbl.cityrtgs.services.configuration.EventService;
...
public class EventController {
    ...
    public ResponseEntity<?> createEvent(@RequestBody @Valid EventRequest request) {
        try {
            ...
            return ResponseHandler.
                    generateResponse("Event has been created successfully",
                            HttpStatus.OK,
                            request);
        } catch (Exception ex) {
    ...
    public ResponseEntity<?> getAll(Pageable pageable,
        ...
        try {
            Page<EventResponse> responseList = service.getAll(unPaged ? PageRequest.of(0, Integer.MAX_VALUE, pageable.getSort()) : pageable);
    ...
    public ResponseEntity<?> updateEvent(@PathVariable Long id, @RequestBody @Valid EventRequest request) {
        try {
            Boolean exist = service.existOne(id);
            if (!exist) return ResponseEntity.notFound().build();
            service.updateOne(id, request);
            return ResponseHandler.generateResponse("Event has been updated successfully", HttpStatus.OK, request);
        } catch (Exception ex) {
            return ResponseHandler.generateResponse(ex.getMessage(), HttpStatus.INTERNAL_SERVER_ERROR, null);
        }
    }
    ...
    public ResponseEntity<?> deleteEvent(@PathVariable Long id) {
        ...
        return ResponseHandler.generateResponse("Event Deleted Successfully", HttpStatus.OK, null);
    }
}
