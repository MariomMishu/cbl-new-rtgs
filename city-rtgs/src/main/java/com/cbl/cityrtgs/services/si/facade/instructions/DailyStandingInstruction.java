...
import com.cbl.cityrtgs.services.si.job.DailySiJob;
...
public class DailyStandingInstruction implements SiFacade {
    ...
    public void executeStandingInstruction(SiUpcomingItem siUpcomingItem, Long interCustomerFundTransferId) {
        ...
        try {
            ...
            log.info("Scheduling Daily SI JOB: {}", siUpcomingItem.getId());
            ...
            JobDetail job = newJob(DailySiJob.class)
                    .usingJobData(map)
