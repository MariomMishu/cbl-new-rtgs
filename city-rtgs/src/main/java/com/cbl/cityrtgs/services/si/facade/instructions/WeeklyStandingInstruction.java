...
import com.cbl.cityrtgs.services.si.job.WeeklySiJob;
...
@Component
public class WeeklyStandingInstruction implements SiFacade {
    ...
    public void executeStandingInstruction(SiUpcomingItem siUpcomingItem, Long interCustomerFundTransferId) {
        ...
        try {
            ...
            log.info("Scheduling Weekly SI JOB: {}", siUpcomingItem.getId());
            ...
            JobDetail job = newJob(WeeklySiJob.class)
                    .usingJobData(map)
