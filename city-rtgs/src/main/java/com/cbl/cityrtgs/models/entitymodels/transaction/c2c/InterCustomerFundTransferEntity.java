...
@Entity
@Table(name = EntityConstant.INTERCUSTOMERFUNDTRANSFER, uniqueConstraints = @UniqueConstraint(columnNames = {"BATCHNUMBER"}))
@Getter
@Setter
@Accessors(chain = true)
@NoArgsConstructor
@AllArgsConstructor
public class InterCustomerFundTransferEntity extends BaseEntity {
    @Id
    @Column(name = "ID")
    ...
    @Column(name = "BATCHCHARGE")
    private boolean batchChargeEnable = false;
