...
/**
 * <p>Java class for CAMT053Charges4 complex type.
 *
 * <p>The following schema fragment specifies the expected content contained within this class.
 *
 * <pre>
 * &lt;complexType name="CAMT053Charges4"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element name="Rcrd" type="{urn:iso:std:iso:20022:tech:xsd:camt.053.001.04}CAMT053ChargesRecord2" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "CAMT053Charges4", propOrder = {
        "ttlChrgsAndTaxAmt",
        "rcrd"
})
public class CAMT053Charges4 {

    @XmlElement(name = "TtlChrgsAndTaxAmt")
    protected ActiveOrHistoricCurrencyAndAmount ttlChrgsAndTaxAmt;
    @XmlElement(name = "Rcrd")
    protected List<CAMT053ChargesRecord2> rcrd;
     ...
     * {@link CAMT053ChargesRecord2 }
     */
    public List<CAMT053ChargesRecord2> getRcrd() {
        if (rcrd == null) {
            rcrd = new ArrayList<CAMT053ChargesRecord2>();
        }
        return this.rcrd;
    }
