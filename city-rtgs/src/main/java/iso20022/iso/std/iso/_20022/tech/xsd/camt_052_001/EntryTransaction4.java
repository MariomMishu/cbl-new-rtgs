 ...
 *         &lt;element name="RltdRmtInf" type="{urn:iso:std:iso:20022:tech:xsd:camt.052.001.04}CAMT052RemittanceLocation2" maxOccurs="10" minOccurs="0"/&gt;
 *         &lt;element name="RmtInf" type="{urn:iso:std:iso:20022:tech:xsd:camt.052.001.04}CAMT052RemittanceInformation7" minOccurs="0"/&gt;
...
public class EntryTransaction4 {
    ...
    protected List<CAMT052RemittanceLocation2> rltdRmtInf;
    @XmlElement(name = "RmtInf")
    protected CAMT052RemittanceInformation7 rmtInf;
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link CAMT052RemittanceLocation2 }
     */
    public List<CAMT052RemittanceLocation2> getRltdRmtInf() {
        if (rltdRmtInf == null) {
            rltdRmtInf = new ArrayList<CAMT052RemittanceLocation2>();
        }
     ...
     *
     * @return possible object is
     * {@link CAMT052RemittanceInformation7 }
     */
    public CAMT052RemittanceInformation7 getRmtInf() {
        return rmtInf;
    }
     ...
     *              {@link CAMT052RemittanceInformation7 }
     */
    public void setRmtInf(CAMT052RemittanceInformation7 value) {
        this.rmtInf = value;
    }
